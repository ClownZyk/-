<template>
  <div>
    ...
    <el-form v-loading="detailLoading" ref="form" :model="form" label-width="80px" label-position="top" :rules="rules">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="团购名称" prop="activityName"> <el-input v-model="form.activityName" placeholder="请输入团购名称"></el-input> </el-form-item>
              </el-col>
            </el-row>
            <!--
              <el-row :gutter="10">
                ...
                <el-col :span="6" v-show="form.isLimit">
                  <el-form-item label="限购数量" prop="limitNum"> <el-input-number v-model="form.limitNum" placeholder="限购数量" :controls="false" :min="0" :step="1" step-strictly style="width: 100%"></el-input-number> </el-form-item>
                </el-col>
              </el-row>
            -->
          </el-row>
          <el-row>
            ...
            <el-row>
              <el-form-item label="团购商品" prop="productName"> <el-input type="text" v-model.trim="form.productName" placeholder="请输入商品名称"></el-input> </el-form-item>
              <el-form-item>
                  ...
                  <el-table-column align="center" prop="costPrice" label="成本价" min-width="110" show-overflow-tooltip>
                    <template slot-scope="scope">
                      <el-input-number
                        ...
                        :controls="false"
                        label="成本价"
                        @change="inputChange($event, scope.row, 'costPrice')"
                        style="width: 100%"
                      ></el-input-number>
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column align="center" prop="limitNum" label="限购(0为无限购)" min-width="140" show-overflow-tooltip>
                    <template slot-scope="scope">
                      <el-input-number
                        ...
                        :step="1"
                        step-strictly
                        @change="inputChange($event, scope.row, 'limitNum')"
                        style="width: 100%"
                      ></el-input-number>
                    </template>
                  </el-table-column>
...
<script>
import { grouponTemplateOperation, getGrouponTemplateDetail } from '@/api/system'
...
export default {
  ...
  data() {
    return {
      ...
      detailLoading: false,
      rules: {
        activityName: [{ required: true, message: '请输入模板活动名称', trigger: 'blur' }],
  ...
  methods: {
    init() {
      ...
      getGrouponTemplateDetail(parmas)
        .then(res => {
      ...
      this.$refs['form'].validate(valid => {
        if (valid) {
          ...
          this.$confirm('确认提交数据吗？', '提示', {
            ...
            .then(() => {
              this.$set(this.form, 'creater', localStorage.getItem('creater'))
              this.$set(this.form, 'roleId', localStorage.getItem('roleId'))
              this.$set(this.form, 'cid', localStorage.getItem('cid'))
              let params = {
              ...
              grouponTemplateOperation(params)
                .then(res => {
                  this.$message({
                    message: res.msg,
    ...
    clear() {
      this.submitLoading = false
      this.$router.push('/groupon-template')
    }
  }
}
</script>
