<template>
  <div class="list-container">
    ...
    <el-form class="filters">
      ...
      <!-- <el-form-item>
        <el-button v-if="!isManage && loginData.attribute === 4" type="primary" @click="operateForm('', '添加', 'Add')">新增</el-button>
        <el-button v-if="!isManage && loginData.attribute === 4" type="danger" @click="operateDeleteMany(datas)">批量删除</el-button>
      </el-form-item> -->
    </el-form>
    <!-- 树形表格部分 -->
        ...
        <li v-for="(item, index) in datas" :key="index">
          <div class="table-tr">
            ...
            <div class="operate">
              ...
              <!-- <el-button type="primary" v-if="loginData.attribute === 4" size="mini" @click="operateForm(item._id, '添加', 'AddSon')">添加子类</el-button> -->
