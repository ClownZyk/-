    ...
    <div class="vote-list" v-if="containerIsShow">
      ...
      <el-form class="filters" ref="searchForm" :model="search" :inline="true">
        <div class="filters-left">
          <el-form-item  label="">
            <el-input v-model="search.activityName" placeholder="请输入会员名称" class="filters-search" @keyup.enter.native="GetListByPage"></el-input>
      ...
      <div class="list-table">
        <el-table class="table-main" :data="lists" border tooltip-effect="dark" v-loading="listLoading">
          ...
          <el-table-column label="会员头像" align="center" type="index" width="150">
            <!-- <template slot-scope="scope">
              <div class="user-img"></div>
            </template> -->
          </el-table-column>
          <el-table-column align="center" prop="createTime" label="会员名称" min-width="180" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="name" label="会员手机号" min-width="130"  show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="pointTime" label="订单笔数" min-width="180" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="qcTime" label="订单总额" min-width="130" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="qcTime" label="用户客单价" min-width="130" show-overflow-tooltip></el-table-column>
  ...
  export default {
    ...
    data () {
      return {
        ...
        lists: [
          {createTime: '2019/01/21', name: '300', pointTime: '100', qcTime: '200'}
        ],
        // 列表
        list: [],
        // 控制loading是否显示
