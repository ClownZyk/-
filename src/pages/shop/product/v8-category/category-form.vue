  ...
  <el-dialog :visible.sync="formV" :title="operateTitle" width="800px" @closed="closed">
    <el-form :model="form" label-width="80px" :rules="formRules" ref="form" class="form" :inline="true">
      <el-form-item label="名称" prop="categoryName">
        <el-input v-model="form.categoryName" style="width:640px;"></el-input>
      </el-form-item>
      <el-form-item label="父类" prop="belong">
        <el-cascader style="width:270px;"
                     ...
                     :props="formProps"></el-cascader>
        <!-- <el-select v-model="form.belong" style="width:270px;" clearable>
          <el-option v-for="(item, index) in belongList" :key="index" :label="item.categoryName" :value="item._id"></el-option>
        </el-select> -->
      </el-form-item>
      <el-form-item label="级数" prop="level" label-width="86px">
        <el-input-number controls-position="right" v-model="form.level" style="width:270px;"></el-input-number>
      </el-form-item>
      <el-form-item label="链接" prop="url">
        <el-input v-model="form.url" style="width:270px;"></el-input>
      </el-form-item>
      <el-form-item label="排序号" prop="sortNo" label-width="86px">
        <el-input-number controls-position="right" v-model="form.sortNo" style="width:270px;" placeholder="最小值为99" :min="99"></el-input-number>
      </el-form-item>
      <el-form-item label="简介" prop="remark">
        <el-input v-model="form.remark" style="width:640px;" type="textarea" :rows="4"></el-input>
      </el-form-item>
