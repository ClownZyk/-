    ...
    <el-form ref="form" :model="form" label-width="80px" label-position="top"  class="form-contain" :rules="rules">
      ...
      <el-form-item>
        ...
        <el-table class="product-list" :data="form.voucher" border tooltip-effect="dark">
              ...
              <el-table-column align="center" prop="quantity" label="总库存" min-width="140" show-overflow-tooltip></el-table-column>
              ...
              <el-table-column align="center" prop="amount" label="消费金额" width="165" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-input-number  controls-position="right" size="mini" :precision="2" v-model="scope.row.amount"></el-input-number>
                </template>
              </el-table-column>
