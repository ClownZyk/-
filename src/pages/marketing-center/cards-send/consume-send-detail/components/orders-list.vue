    ...
    <div class="vote-list" >
      ...
      <div class="list-table">
        <el-table class="table-main" ref="listTable" :data="list" border tooltip-effect="dark" v-loading="listLoading">
          ...
          <el-table-column align="center" prop="voucher.title" label="卡劵名称" min-width="180" show-overflow-tooltip></el-table-column>
...
<script type="text/ecmascript-6">
  import {GetGiveRecordByPage} from '@/api/system'
  export default {
    name: 'vote-list',
    data () {
      return {
    ...
    methods: {
      ...
      async GetListByPage () {
        ...
        await GetGiveRecordByPage(params).then(res => {
