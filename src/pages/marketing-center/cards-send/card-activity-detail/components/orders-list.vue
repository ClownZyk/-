    ...
    <div class="vote-list">
      ...
      <div class="list-table">
        <el-table class="table-main" ref="listTable" :data="list" border tooltip-effect="dark" v-loading="listLoading">
          ...
          <el-table-column align="center" prop="phone" label="购买人手机号" min-width="180" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.phone || '--' }}</template>
          </el-table-column>
          <!-- <el-table-column align="center" prop="title" label="卡劵名称" min-width="180" show-overflow-tooltip></el-table-column> -->
          <el-table-column align="center" prop="createTime" label="使用状态" min-width="180" show-overflow-tooltip>
            <template slot-scope="scope">
              <div style="color: #67C23A;" v-if="scope.row.isUsed">已使用</div>
              <div style="color: #F56C6C;" v-else>未使用</div>
            </template>
          </el-table-column>
          <el-table-column align="center" prop="createTime" label="使用时间" min-width="180" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.isUsed ? scope.row.useTime : '--'}}</template>
          </el-table-column>
          <!--
...
// import Template from '../../../../shop/shop-setting/template.vue'
export default {
  name: 'vote-list',
  data () {
    return {
  ...
  methods: {
    ...
    GetListByPage () {
      ...
      let params = {
        customerId: '',
        cardType: this.$route.query.type,
        cardId: this.$route.query.cardId,
