<template>
  <div>
    ...
    <el-button type="primary" size="medium" @click="submitPanForm" :disabled="!canSubmitBtn">创建转盘活动</el-button>
  </div>
</template>
<script>
import myUpload from '@/components/my-upload'
import Filters from '@/components/js/Filters'
import { GetAllCardByPage, panOperation } from '@/api/system'
const awardsItem = {
  jiangPinLevel: '',
  jiangPinType: '',
  cardType: '',
