    ...
    <div class="groupon-list" v-if="containShow">
      ...
      <div class="list-table">
        <el-table class="table-main" ref="listTable" :data="grouponList" border tooltip-effect="dark" v-loading="listLoading">
          ...
          <el-table-column align="center" prop="number" label="产品数量" min-width="100" show-overflow-tooltip></el-table-column>
...
import {GetSetMeal, SetMealOperation} from '@/api/system'
export default {
  name: 'groupon-list',
  watch: {
    '$route' (to, from) {
      if (to.name === 'muliti-activity') {
        this.GetListByPage()
  ...
  methods: {
    ...
    async GetListByPage () {
      ...
      await GetSetMeal(params).then(res => {
