<template>
  <div>
    <el-table class="table-main" v-loading="loading" :data="productList" size="mini" border>
      ...
      <el-table-column align="center" prop="firstCategoryName" label="一级分类" width="100" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" prop="secCategoryName" label="二级分类" width="100" show-overflow-tooltip></el-table-column>
...
<script>
import { DataStatistics } from '@/api/system'
export default {
  data() {
    return {
      productList: [],
