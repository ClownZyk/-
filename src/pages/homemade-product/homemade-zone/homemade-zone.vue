  ...
  <div class="zone-container">
    <div class="filter">
      <el-form class="filter-left" :model="searchForm" :inline="true">
        <el-form-item>
          <el-input v-model="searchForm.zoneName" placeholder="请输入区名检索" clearable></el-input>
        </el-form-item>
        <el-form-item>
...
<script>
import { getMakeZoneList, makeZoneOperation } from '@/api/system'
export default {
  data() {
    return {
      searchForm: {
