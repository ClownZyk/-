<template>
  <div class="list-container">
    ...
    <el-form class="filters">
      ...
      <el-form-item>
        <el-button type="primary" @click="operateForm('', '添加', 'Add')" v-permission="['/homemade-product-category:insert']">新增</el-button>
          ...
          <div class="table-tr">
            ...
            <div class="operate">
              ...
              <!-- <el-button type="primary" size="mini" @click="operateForm(item._id, '添加', 'AddSon')"
                >添加子类</el-button
              > -->
              <el-button type="danger" size="mini" @click="operateDelete(item)" v-permission="['/homemade-product-category:delete']">删除</el-button>
            </div>
          </div>
          <!-- 多级子分类 -->
