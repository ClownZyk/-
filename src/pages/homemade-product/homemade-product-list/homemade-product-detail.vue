            ...
            <el-row :gutter="10">
              ...
              <el-col :span="7">
                <el-form-item prop="categoryId">
                  ...
                  <el-cascader v-model="productForm.categoryId" :options="categoryList" :props="props" placeholder="请选择产品分类" :disabled="!isManage" style="width:100%"></el-cascader>
                </el-form-item>
              </el-col>
            ...
            <el-row :gutter="10">
              ...
              <!-- <el-col :span="8">
                <el-form-item>
                  ...
                  <el-input-number :controls="false" v-model="productForm.sales" placeholder="请输入销售量" :min="0" :step="1" step-strictly disabled style="width:100%"></el-input-number>
                </el-form-item>
              </el-col> -->
              <el-col :span="8">
                <el-form-item>
          ...
          <el-table :data="productForm.sku" style="width: 100%" :default-expand-all="true" border size="small">
            <el-table-column type="expand" width="100">
              <template slot-scope="scope">
                <el-table :data="scope.row.recipe" style="width: 50%" border size="small">
            ...
            <el-table-column label="配方" min-width="100" align="center" show-overflow-tooltip>
              <template slot-scope="scope">
                <el-button type="warning" size="mini" :disabled="!scope.row.isAddOrEdit || !isManage" @click="handleSelectRecipe(scope.$index, 'recipe')">添加配方</el-button>
              </template>
            </el-table-column>
...
<script>
import { GetAllCategory, vShopMakeProductOperation, getVShopMakeProductDetail, getMakeZoneList } from '@/api/system'
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      getVShopMakeProductDetail(params)
        .then(res => {
          if (res.success) {
          ...
          vShopMakeProductOperation(params)
            .then(res => {
              if (res.success) {
                ...
                this.$router.push('/homemade-product-list')
              }
            })
            .catch(() => {
              this.submitLoading = false
