...
<script>
import { getRawProduct, rawProductOperation, batchAddRawProduct, GetAllCategory, SynchronismCategory, rawProductV8Sync } from '@/api/system'
...
export default {
  ...
  methods: {
    ...
    sumbitRawProduct(rawProduct) {
      ...
      // console.log(params)
      batchAddRawProduct(params).then(
        res => {
          if (res.success) {
            this.$message.success(res.msg)
            this.getRawProduct()
