...
<script>
import { getWeighBatchList, weighBatchOperation, weighBatchScrap } from '@/api/system.js'
  ...
  methods: {
    ...
    editBatch() {
      this.$confirm('确认编辑？', '提示', {
        ...
        weighBatchOperation(parmas).then(
          res => {
            if (res.success) {
