      ...
      <el-form ref="form" :model="form" label-width="80px" label-position="top" class="form-contain" :rules="rules" :disabled="formDisabled">
        ...
        <div class="form-contain-item">
          <el-form-item prop="limit">
            <div class="form-item-title">产品数量限制<span class="border"></span><span class="EnName">LIMIT</span></div>
            <el-input-number controls-position="right" :precision="0" v-model="form.limit" :min="2" placeholder="产品数量限制" class="item-middle"></el-input-number>
          </el-form-item>
        ...
        <div class="form-contain-item" v-show="false">
            ...
            <div>
              ...
              <div v-show="form.dateInfo.dateType === 2" class="use-type">
                <div class="use-txt">
                  ...
                  <el-input-number controls-position="right" size="mini" :precision="0" :min="1" class="use-input" v-model="form.dateInfo.fixedTerm"></el-input-number><span class="use-span">天</span>
                </div>
              </div>
            </div>
          </el-form-item>
