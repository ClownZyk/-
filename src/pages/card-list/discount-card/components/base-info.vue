      ...
      <el-form ref="form" :model="form" label-width="80px" label-position="top" class="form-contain" :rules="rules" :disabled="formDisabled">
        ...
        <div class="form-contain-item">
          <el-form-item prop="discount">
            <div class="form-item-title">打折额度(填30就是七折)<span class="border"></span><span class="EnName">DISCOUNT</span></div>
            <el-input-number controls-position="right" :precision="0" v-model="form.discount" :min="0" placeholder="打折额度" class="item-middle"></el-input-number>
          </el-form-item>
          <el-form-item prop="max">
            <div class="form-item-title">最高优惠(0: 不设上限)<span class="border"></span><span class="EnName">MAX</span></div>
            <el-input-number controls-position="right" :precision="0" v-model="form.max" :min="0" placeholder="最高优惠" class="item-middle"></el-input-number>
          </el-form-item>
        </div>
        <div class="form-contain-item">
