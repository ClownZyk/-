<template>
  <div>
    <div class="gem-back-header"><el-page-header @back="$router.back()" content="支付分订单详情"> </el-page-header></div>
      ...
      <el-row>
        ...
        <el-form-item label="产品信息">
          <el-table :data="orderDetail.post_payments" border>
            ...
            <el-table-column label="产品价格" min-width="240" align="center">
          ...
          <div style="margin-top: 10px">总金额：{{ total_amount }}</div>
        </el-form-item>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    refundPayScoreOrderDeatil() {
      this.$router.push({ path: '/pay-score-refund-order', query: { oriOrderId: this.orderDetail.out_order_no } })
    }
  }
}
</script>
