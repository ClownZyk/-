<template>
  <el-dialog :visible.sync="formV" :title="operateTitle" width="800px" @closed="closed">
    <el-form ref="form" :model="form" :rules="formRules" label-width="86px" label-position="right">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="分类名称" prop="categoryName"> <el-input v-model.trim="form.categoryName" clearable></el-input> </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="分类编码" prop="code"> <el-input v-model.trim="form.code" clearable></el-input> </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="所属父类" prop="belong">
            <el-cascader v-model="form.belongs" :options="belongList" :props="formProps" @change="changeBelong" placeholder="请选择所属父类（一级分类不用选）" style="width:100%"></el-cascader>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="分类级数" prop="level" label-width="86px"> <el-input-number v-model="form.level" :min="0" :step="1" step-strictly placeholder="分类级数" style="width:100%"></el-input-number> </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
