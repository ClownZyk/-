<template>
  <!-- 商品选择器（单选版本） -->
  <el-dialog :visible.sync="isShow" :title="isNjV8 === 1 ? '南京V8商品选择器' : '西安V8商品选择器'" width="1100px" @closed="closed">
    <!-- 搜索部分 -->
    ...
    <el-table size="small" v-loading="listLoading" class="table-main" ref="listTable" :data="productList" border>
      <el-table-column prop="productName" label="产品名称" min-width="260" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" prop="categorysName" label="产品分类" width="150" show-overflow-tooltip> </el-table-column>
